package me.chin.paycore.wx.response;
 ...
 */
public class WxApiOrderQueryResponse extends WxApiResponse {
    // TODO 代金券ID coupon_id_$n,代金券类型 coupon_type_$n,单个代金券支付金额 coupon_fee_$n解析较为麻烦，这里暂省略不解析
    ...
    @ApiField(value="settlement_total_fee")
    private String settlementTotalFee;
    @ApiField(value="trade_state_desc")
    private String tradeStateDesc;
    @ApiField(value="trade_state")
